...
##  - Codes run in Flash and data initialization value and ram-code storage are assigned into two separate blocks: 
##    p_Code and p_storage, adjust the size of the two blocks according to the actual situation
##
##              Program_space
##              -------------
##    0x0000:
...
MEMORY {
  ...
  .p_Code         (RWX): ORIGIN = 0x00000208, LENGTH = 0x0000BDF8 # 48KWords of Flash for codes running in Flash
  .p_storage      (RWX): ORIGIN = 0x0000C000, LENGTH = 0x00004000 # 16KWords of Flash for data initialization value and ram-code storage
