...
#####################################################################
##
##  M56F83x8x linker file - Flash mapped into data space range 0x8000~0xbfff is not used 
##  
##  Notes:
...
FLASH_PARTITION {
  ...
  FlashImage   : ORIGIN_P = 0x000000, ORIGIN_X = 0x020000, LENGTH = 0x20000 > FlashImage.bin
  # FlashPart1 : ORIGIN_P = 0x000000, ORIGIN_X = 0x020000, LENGTH = 0x10000
  # FlashPart2 : ORIGIN_P = 0x010000, ORIGIN_X = 0x030000, LENGTH = 0x10000
}
...
MEMORY {
  ...
  .p_Code         (RWX): ORIGIN = 0x00000208, LENGTH = 0x0001FDF8 # 128KWords for codes running in Flash
